package com.minjihong.cloudalibaba.provider.payment.controller;
...
public class PaymentController {
    ...
    static {
        hashMap.put(1L, new Payment(1L, "28a8c"));
        hashMap.put(2L, new Payment(1L, "bba8c"));
        hashMap.put(3L, new Payment(1L, "6ua8c"));
    }
