package com.minjihong.cloudalibaba.sentinel.service.controller;
...
import com.minjihong.cloudalibaba.sentinel.service.myhandler.CustomerBlockHandler;
...
public class RateLimitController {
    ...
    public CommonResult customerBlockHandler() {
        return new CommonResult(200, "按客户自定义限流测试ok", new Payment(2020L, "serial1002"));
    }
